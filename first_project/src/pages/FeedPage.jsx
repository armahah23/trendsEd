        ...
        <div className="feed-container">
          <div className="new-post">
            ...
            <div className="input-item">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTC7SZTPcckf1edykBhbymn4lG5kWycLiRIvQ&s"
                alt="addImg"
              />
              <img
                src="https://icons.iconarchive.com/icons/fa-team/fontawesome/512/FontAwesome-User-Tag-icon.png"
                alt="tag"
              />
              <img
